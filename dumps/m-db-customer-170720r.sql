...
-- Dumping structure for table mache.m_cust_so
CREATE TABLE IF NOT EXISTS `m_cust_so` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(64) NOT NULL DEFAULT '',
  `name` varchar(128) NOT NULL DEFAULT '',
  `address` varchar(512) NOT NULL DEFAULT '',
  `id_parentcust` int(11) NOT NULL DEFAULT '1',
  `code_parentcust` varchar(64) NOT NULL DEFAULT 'NONE',
  ...
  `code_city` varchar(64) NOT NULL DEFAULT 'NONE',
  `id_outlettype` int(11) NOT NULL DEFAULT '1',
  `code_outlettype` varchar(64) NOT NULL DEFAULT 'NONE',
  `id_channel` int(11) NOT NULL,
  `code_channel` varchar(64) NOT NULL DEFAULT '',
  `id_subchannel` int(11) NOT NULL DEFAULT '1',
  `code_subchannel` varchar(64) NOT NULL DEFAULT 'NONE',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8952 DEFAULT CHARSET=latin1;
